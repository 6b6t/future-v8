...
extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.mc.fontRenderer.drawStringWithShadow(String.format("%s* \u00a77Username", new Object[]{this.usernameBox.getText().length() > 1 ? EnumChatFormatting.GREEN : EnumChatFormatting.RED}), this.width / 2 - 109, 63.0f, 0xA0A0A0);
